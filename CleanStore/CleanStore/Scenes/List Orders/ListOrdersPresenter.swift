  ...
  weak var viewController: ListOrdersDisplayLogic?
    ...
    func presentFetchedOrders(response: ListOrders.FetchOrders.Response) {
        ...
        for order in response.orders {
            ...
            let displayedOrder = ListOrders.FetchOrders.ViewModel.DisplayedOrder(id: order.id!, date: dateFormatter, email: order.email, name: "\(order.firstName) \(order.lastName)", total: total!)
